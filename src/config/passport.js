...
passport.use('google', new GoogleStrategy({
  ...
  callbackURL: process.env.PORT && process.env.PORT !== '5000' ? 'https://localecom-backend.onrender.com/api/auth/google/callback' : 'http://localhost:5000/api/auth/google/callback',
  scope: ['profile', 'email']
